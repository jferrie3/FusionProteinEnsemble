...
export WDIR=/global/home/users/jferrie/TG_HaloSnap/Halo-5xIg-SNAPf/
cd $WDIR
# set the number of jobs
export JOBS_PER_NODE=$(( $SLURM_CPUS_ON_NODE / $SLURM_CPUS_PER_TASK ))
## For a single node
parallel --jobs $SLURM_CPUS_ON_NODE --joblog task.log --resume --progress sh run_cmd_5.sh {} ::: `seq 100`
